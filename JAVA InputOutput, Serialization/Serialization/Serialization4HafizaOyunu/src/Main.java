...
public class Main {
    ...
    public static void kayittan_al() {
        ...
        if (file.exists()) {
            ...
            System.out.print("Kaydedilmis bir oyununuz var. Kayittan devam etmek ister misiniz?");
