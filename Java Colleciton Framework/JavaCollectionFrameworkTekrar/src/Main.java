public class Main {
    ...
    Elemanlar listler gibi indekslenmezler. // Direkt olarak erişim sağlayamıyoruz
    Bir elemanı setlerde olup olmadığını sorgulama listlere göre oldukça hızlıdır. //Çünkü hashset implemente ediyor
    ...
    (treeset ne kadar büyük olursa arama zamanı o kadar büyür)
